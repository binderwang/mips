...
%  ======================== LOW LEVEL SETTINGS =========================  %
modelname =    'kuka';
jointformat = '%s_joint%d';
part_names = ' ';
controltype = 'position';
statevec = ['position' , 'velocity'];
extractpose = @func1;     % define func 1
rewardfunction = @func2;  % define func 2
startingstate = [];
mdp = VREPintfc(modelname,jointformat,part_names,controltype,statevec,extractpose,rewardfunction,startingstate);
robj = 1;
dreward = mdp.dreward;
gamma = mdp.gamma;
daction = mdp.daction;
